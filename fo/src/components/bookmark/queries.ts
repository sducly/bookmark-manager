...
mutation UpdateBookmark($id: Int, $type: String, $url: String, $title: String, $authorName: String, $addedDate: String, $width: Int, $height: Int, $thumbUrl: String, $userId: Int) {
  update: updateBookmark(id: $id, type: $type, url: $url, title: $title, authorName: $authorName, addedDate: $addedDate, width: $width, height: $height, thumbUrl: $thumbUrl, userId: $userId) {
    id type url title authorName addedDate width height thumbUrl
  }
}
`